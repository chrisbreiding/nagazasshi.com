(function(d){function j(e,b,c,f){function a(){b.timeout&&(g.cycleTimeout=setTimeout(function(){j(e,b,0,!b.rev)},b.timeout))}if(!b.busy){var g=e[0].parentNode,h=e[b.currSlide],i=e[b.nextSlide];if(0!==g.cycleTimeout||c)c||!g.cyclePause?(b.before.length&&d.each(b.before,function(a,c){c.apply(i,[h,i,b,f])}),b.nextSlide!=b.currSlide&&(b.busy=1,d.fn.cycle.custom(h,i,b,function(){d.browser.msie&&this.style.removeAttribute("filter");d.each(b.after,function(a,c){c.apply(i,[h,i,b,f])});a()})),c=b.nextSlide+
1==e.length,b.nextSlide=c?0:b.nextSlide+1,b.currSlide=c?e.length-1:b.nextSlide-1):a()}}function k(d,b,c){var f=d[0].parentNode,a=f.cycleTimeout;a&&(clearTimeout(a),f.cycleTimeout=0);b.nextSlide=b.currSlide+c;0>b.nextSlide?b.nextSlide=d.length-1:b.nextSlide>=d.length&&(b.nextSlide=0);j(d,b,1,0<=c);return!1}d.fn.cycle=function(e){return this.each(function(){e=e||{};this.cycleTimeout&&clearTimeout(this.cycleTimeout);this.cyclePause=this.cycleTimeout=0;var b=d(this),c=e.slideExpr?d(e.slideExpr,this):
...
a,!0]);1<a.after.length&&a.after[1].apply(b,[b,b,a,!0]);a.click&&!a.next&&(a.next=a.click);a.next&&d(a.next).unbind("click.cycle").bind("click.cycle",function(){return k(f,a,a.rev?-1:1)});a.prev&&d(a.prev).unbind("click.cycle").bind("click.cycle",function(){return k(f,a,a.rev?1:-1)});a.timeout&&(this.cycleTimeout=setTimeout(function(){j(f,a,0,!a.rev)},a.timeout+(a.delay||0)))}})};d.fn.cycle.custom=function(e,b,c,f){var a=d(e),g=d(b);g.css(c.cssBefore);var h=function(){g.animate(c.animIn,c.speedIn,
c.easeIn,f)};a.animate(c.animOut,c.speedOut,c.easeOut,function(){a.css(c.cssAfter);c.sync||h()});c.sync&&h()};d.fn.cycle.transitions={fade:function(d,b,c){b.not(":eq(0)").hide();c.cssBefore={opacity:0,display:"block"};c.cssAfter={display:"none"};c.animOut={opacity:0};c.animIn={opacity:1}},fadeout:function(e,b,c){c.before.push(function(b,a,c,e){d(b).css("zIndex",c.slideCount+(!0===e?1:0));d(a).css("zIndex",c.slideCount+(!0===e?0:1))});b.not(":eq(0)").hide();c.cssBefore={opacity:1,display:"block",zIndex:1};
c.cssAfter={display:"none",zIndex:0};c.animOut={opacity:0}}};d.fn.cycle.ver=function(){return"Lite-1.5"};d.fn.cycle.defaults={animIn:{},animOut:{},fx:"fade",after:null,before:null,cssBefore:{},cssAfter:{},delay:0,fit:0,height:"auto",metaAttr:"cycle",next:null,pause:0,prev:null,speed:1E3,slideExpr:null,sync:1,timeout:4E3}})(jQuery);